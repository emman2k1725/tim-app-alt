...
class BusinessAdsTable extends StatefulWidget {
  ...
  @override
  _BusinessAdsTableDemoState createState() => _BusinessAdsTableDemoState();
}

class _BusinessAdsTableDemoState extends State<BusinessAdsTable> {
