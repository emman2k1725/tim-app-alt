...
class ManageAdsModal extends StatefulWidget {
  final Map<String, dynamic> item;
  const ManageAdsModal({super.key, required this.item});

  @override
  State<ManageAdsModal> createState() => _ManageAdsModalState();
}

class _ManageAdsModalState extends State<ManageAdsModal> {
  @override
            ...
            ? ElevatedButton(
                onPressed: () async {
                  ...
                  await updateBusinessContent(
                          widget.item['docID'], 'advertisement', 'Declined')
                      .then((value) {
                    if (value == 'success') {
                      Navigator.of(context).pop();
                      Navigator.of(context).pop();
        ...
        widget.item['status'] == 'Pending'
            ? ElevatedButton(
                onPressed: () async {
                  ...
                  await updateBusinessContent(
                          widget.item['docID'], 'advertisement', 'Approved')
                      .then((value) {
                    if (value == 'success') {
                      Navigator.of(context).pop();
                      Navigator.of(context).pop();
