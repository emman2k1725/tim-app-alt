...
class CreateAboutDialog extends StatefulWidget {
  const CreateAboutDialog({
    super.key,
  });

  @override
  State<CreateAboutDialog> createState() => _CreateAboutDialogState();
}

class _CreateAboutDialogState extends State<CreateAboutDialog> {
  File? _pickedImage;
